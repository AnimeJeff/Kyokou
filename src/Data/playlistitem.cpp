...
PlaylistItem::PlaylistItem(float number, const std::string &link, const QString &name, PlaylistItem *parent, bool isLocal)
...
void PlaylistItem::emplaceBack(float number, const std::string &link, const QString &name, bool isLocal) {
