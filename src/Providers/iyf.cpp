...
QList<ShowData> IyfProvider::search(QString query, int page, int type) {
...
void IyfProvider::loadDetails(ShowData &show) const {
    ...
    if (infoJson.isEmpty ()) {
        throw MyException("Empty json returned");
    }
