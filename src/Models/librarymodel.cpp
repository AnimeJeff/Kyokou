...
void LibraryModel::updateProperty(const QString &showLink, QString propertyName, QVariant propertyValue, PropertyType propertyType){
...
void LibraryModel::add(ShowData& show, int listType)
{
...
void LibraryModel::remove(ShowData &show)
{
...
void LibraryModel::removeAt(int index, int listType) {
...
void LibraryModel::cycleDisplayingListType() {
    setDisplayingListType ((m_currentListType + 1) % 5);
}

void LibraryModel::move(int from, int to)
{
...
void LibraryModel::changeShowListType(ShowData &show, int newListType)
{
...
void LibraryModel::changeListTypeAt(int index, int newListType, int oldListType) {
...
QVariant LibraryModel::getChangeableListTypes() {
