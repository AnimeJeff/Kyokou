...
public:
    ...
    ShowResponse loadDetails(ShowResponse show){
        ...
        show.description = doc.selectText ("//div[@class=detail_imform_desc_pre]/p").c_str ();
        auto count = 1;
        ...
        show.releaseDate = doc.selectText("//ul[@class='blockcontent']/li[@class='detail_imform_kv'][6]/span[2]/a").c_str ();
